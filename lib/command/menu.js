...
cmd.on('menu-cmd', ['menu'], ['info'], async (msg, {
  ...
  let buttonsMessage = {
    contentText: hasil,
    footerText: `Jika Tidak Bisa Tekan _Tombol_,Tekan Baca Selengkapnya!${f.readmore(1000)}\n\n${list} _${usedPref}infopenggunaan_`,
    buttons,
    headerType: 1
  }
  return client.sendMessageFromContent(msg.from, {
...
cmd.on('menu-info', ['infopenggunaan'], ['info'], (msg, {
  ...
  return client.reply(msg, `*Hai* _${msg.sender.name}_
    ...
    Jika Terdapat Tanda _${bot.unicode.needed[0]}_ Dan _${bot.unicode.needed[1]}_ Artinya Di perlukan Sesuatu

    Contoh: _${bot.unicode.needed[0]}_Teks_${bot.unicode.needed[1]}_

    Artinya Diatas Diperlukan Teks

    Ada juga _${bot.unicode.optional[0]}_ Dan _${bot.unicode.optional[1]}_
    ...
    *fiturnya*
    ...
    Untuk Penggunaan Kedua Contohnya Jika Terdapat _${bot.unicode.needed[0]}_ Dan _${bot.unicode.needed[1]}_ Maka Kurung Tadi Jangan Di Anggap
